                ...
                <div class="carousel-inner border-radius-lg h-100">
                    <div class="carousel-item h-100 active" style="background-image: url('{{ asset('assets/img/carousel-1.jpg') }}'); background-size: cover;">
                        <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                            ...
                            <h5 class="text-white mb-1">Comienza con Argon</h5>
                            <p>No hay nada en la vida que quisiera hacer que no pudiera hacer bien.</p>
                        </div>
                    </div>
                    <div class="carousel-item h-100" style="background-image: url('{{ asset('assets/img/carousel-2.jpg') }}'); background-size: cover;">
                        <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                            ...
                            <h5 class="text-white mb-1">Forma más rápida de crear páginas web</h5>
                            <p>Esa es mi habilidad. No soy especialmente talentoso excepto en la capacidad de aprender.</p>
                        </div>
                    </div>
                    <div class="carousel-item h-100" style="background-image: url('{{ asset('assets/img/carousel-3.jpg') }}'); background-size: cover;">
                        <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                            ...
                            <h5 class="text-white mb-1">¡Comparte con nosotros tus consejos de diseño!</h5>
                            <p>No tengas miedo de equivocarte porque no puedes aprender nada de un cumplido.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                        <tr>
                            <td class="w-30">
                                <div class="d-flex px-2 py-1 align-items-center">
                                    <div>
                                        <img src="{{ asset('assets/img/icons/flags/US.png') }}" alt="Bandera de país">
                                    </div>
                                    <div class="ms-4">
                        ...
                        <tr>
                            <td class="w-30">
                                <div class="d-flex px-2 py-1 align-items-center">
                                    <div>
                                        <img src="{{ asset('assets/img/icons/flags/DE.png') }}" alt="Bandera de país">
                                    </div>
                                    <div class="ms-4">
                                        <p class="text-xs font-weight-bold mb-0">País:</p>
                        ...
                        <tr>
                            <td class="w-30">
                                <div class="d-flex px-2 py-1 align-items-center">
                                    <div>
                                        <img src="{{ asset('assets/img/icons/flags/GB.png') }}" alt="Bandera de país">
                                    </div>
                                    <div class="ms-4">
                                        <p class="text-xs font-weight-bold mb-0">País:</p>
                        ...
                        <tr>
                            <td class="w-30">
                                <div class="d-flex px-2 py-1 align-items-center">
                                    <div>
                                        <img src="{{ asset('assets/img/icons/flags/BR.png') }}" alt="Bandera de país">
                                    </div>
                                    <div class="ms-4">
                                        <p class="text-xs font-weight-bold mb-0">País:</p>
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <span class="text-xs">123 cerrados, <span class="font-weight-bold">15 abiertos</span></span>
                            </div>
                        </div>
                        <div class="d-flex">
                            <button class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto"><i class="ni ni-bold-right" aria-hidden="true"></i></button>
                    ...
                    <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column">
                                <h6 class="mb-1 text-dark text-sm">Registro de errores</h6>
                                <span class="text-xs">1 activo, <span class="font-weight-bold">40 cerrados</span></span>
                            </div>
                        </div>
                        <div class="d-flex">
                            <button class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto"><i class="ni ni-bold-right" aria-hidden="true"></i></button>
