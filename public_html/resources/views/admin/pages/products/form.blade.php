                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-8 col-12">
                            ...
                            <p class="text-sm mb-0">
                                {{ isset($product) ? 'Modifica la información del producto' : 'Completa la información del producto' }}
                            </p>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12 mb-3">
                                                ...
                                                <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                                    rows="4" placeholder="Describe las características del producto...">{{ old('description', $product->description ?? '') }}</textarea>
                                                @error('description')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12 mb-3">
                                                ...
                                                <input type="number"
                                                    ...
                                                    name="stock" value="{{ old('stock', $product->stock ?? 0) }}"
                                    ...
                                    <div class="card-body">
                                                ...
                                                <div class="position-relative">
                                                    <div class="ratio ratio-16x9 rounded-3 overflow-hidden shadow-sm">
                                                        <video id="videoPlayer" controls class="bg-dark">
                                                            <source
                                                                src="{{ asset('storage/' . $product->main_video_path) }}"
                                                                type="video/mp4">
                                        ...
                                        <div id="videoUploadSection">
                                            <label for="main_video_path" class="btn btn-outline-primary w-100">
                                                ...
                                                {{ isset($product) && $product->main_video_path ? 'Cambiar Video' : 'Subir Video' }}
                                            </label>
                                            <input type="file"
                                                class="d-none @error('main_video_path') is-invalid @enderror"
                                            ...
                                            <div class="position-relative d-inline-block">
                                                ...
                                                @if (isset($product) && $product->image)
                                                    <button type="button"
                                                        ...
                                                        id="removeImage" data-bs-toggle="tooltip"
...
@push('scripts')
    <script>
        ...
        // Preview de video con información del archivo
        document.getElementById('main_video_path').addEventListener('change', function(e) {
            ...
            if (file) {
                ...
                // Crear nuevo elemento de video para preview
                ...
                <div class="position-relative">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-2 p-2 bg-light rounded">
                        ...
                        <span class="badge bg-success">
                            <i class="fas fa-check me-1"></i>Nuevo
                        </span>
                    </div>
                </div>
            `;
...
@push('styles')
    <style>
        ...
        /* Mejorar apariencia del placeholder */
        #noVideoPlaceholder {
